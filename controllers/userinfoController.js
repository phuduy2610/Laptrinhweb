...
exports.edit = async (req, res, next) => {
    ...
    if (flag != 0) {
        await UserInfoModel.updateuserById("1", { name: formfields.name, birthday: formfields.birthday, phone: formfields.phone, email: formfields.email, cover: formfields.cover });
    }
    else {
        await UserInfoModel.updateuserById("1", { name: formfields.name, birthday: formfields.birthday, phone: formfields.phone, email: formfields.email });
    }

    const user = await UserInfoModel.getonebyname(formfields.name);
    res.render('userinfo/userinfo', { user });
